...
export const Bookings: CollectionConfig = {
  ...
  fields: [
    ...
    { name: 'flightNumber', type: 'text', label: 'Flight Number (for Airport Transfers)' },
    { name: 'airportTerminal', type: 'text', label: 'Airport Terminal' },
    { name: 'gstin', type: 'text', label: 'Customer GSTIN' },
    { name: 'companyName', type: 'text', label: 'Customer Company Name' },
    {
      name: 'securityDepositAmount',
      type: 'number',
      defaultValue: 0,
      label: 'Security Deposit Held (₹)',
      admin: { description: 'Refundable deposit amount held for self-drive bookings.' },
    },
    {
      ...
      defaultValue: 'na',
      options: [
        { label: 'Not Applicable (Chauffeur / Zero Deposit)', value: 'na' },
        { label: 'Deposit Held', value: 'held' },
        { label: 'Inspection Passed (Refund Pending)', value: 'inspection_passed' },
        { label: 'Refund Dispatched (UTR Attached)', value: 'refunded' },
        { label: 'Deducted / Forfeited', value: 'deducted' },
      ],
      label: 'Security Deposit Status',
    },
    {
      name: 'depositRefundUtr',
      type: 'text',
      label: 'Deposit Refund Bank UTR',
      admin: { description: 'Bank transfer reference number sent to the customer.' },
    },
    {
      name: 'depositRefundDeductionReason',
      type: 'text',
      label: 'Deposit Deduction Reason (if any tolls/damages)',
    },
    {
    ...
    },
    {
      ...
      type: 'group',
      label: 'Assigned Chauffeur Dossier',
      fields: [
        { name: 'name', type: 'text', label: 'Chauffeur Name' },
        { name: 'phone', type: 'text', label: 'Chauffeur Phone' },
        { name: 'photoUrl', type: 'text', label: 'Chauffeur Photo URL' },
        { name: 'vehicleNumber', type: 'text', label: 'Vehicle License Plate' },
        { name: 'carColor', type: 'text', label: 'Vehicle Color' },
        { name: 'assignedAt', type: 'date', label: 'Assigned At' },
      ],
    },
    {
      name: 'assignedWeddingCoordinator',
      type: 'group',
      label: 'Wedding Coordinator Contact',
      fields: [
        { name: 'name', type: 'text', label: 'Coordinator Name' },
        { name: 'phone', type: 'text', label: 'Coordinator Phone' },
      ],
    },
